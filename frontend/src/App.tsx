      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Upload your architectural and MEP plans to extract geometry, dimensions, and generate automated takeoff data with materials lists.
          </p>
          ...
          {currentStep === 'configure' && (
            <div className="space-y-8">
              <div className="max-w-4xl mx-auto bg-white rounded-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Uploaded File</h3>
        ...
        <footer className="text-center mt-16 py-8 border-t border-gray-200">
          <p className="text-sm text-gray-500">
            PlanTakeoff Platform - AI-powered plan analysis and takeoff automation
          </p>
        </footer>
      </div>
    </div>
